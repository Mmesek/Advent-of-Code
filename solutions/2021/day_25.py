...
def move(current_map: list[list[str]]) -> list[list[str]]:
    """If possible, moves cucumbers on matrix"""
...
def find_step(cucumbers_map: list[list[str]]) -> int:
    """Moves as long as matrix changes"""
    i = 0
    while True:
        i += 1
